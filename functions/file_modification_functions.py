...
file_modification_instructions="""**Use this tool set only for filesystem housekeeping. For implementing, patching, searching, or debugging source code, switch to `coding_tools`.**

**START BY SETTING A BASE_DIR USING `set_base_dir` first**

## Objective
- Create, delete, rename, list, or inspect files and directories inside the active base directory.
- Do not use these tools to implement or debug source code.
