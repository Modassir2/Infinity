...
- Many more cool af functions:
  - Auto Call responding (Whatsapp)
- Vision Base by integrating OpenCV and enabling camera , with some face detection.
- VVoice Interaction like STT: Speech-to-Text (Whisper or Vosk) , TTS: Text-to-Speech (EdgeTTS or pyttsx3) so that full Voice Command support ("Hey Infinity").
- Support of image uploading
- Image Generation.
