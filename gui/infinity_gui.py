...
class InfinityGUI:
    ...
    def _build_left_panel(self, parent):
        ...
        self.disc = InfinityDisc(left, size=260)
    ...
    def _build_right_panel(self, parent):
        ...
        self.entry.pack(side="left", fill="x", expand=True, padx=(4, 8), pady=4)
        self.entry.bind("<Return>", self._on_return)
        self.entry.bind("<Shift-Return>", self._on_shift_return)
        self.entry.bind("<KeyRelease>", self._resize_entry)
        self.entry.focus_set()

        self._mkbtn(inner, "CLEAR", self._on_clear_input, RED).pack(side="right", padx=4)
    ...
    def _open_ai_bubble(self):
        self.chat_box.config(state="normal")
        self.chat_box.insert("end", "\n  ASSISTANT\n", "ai_name")
        self.chat_box.mark_set("ai_bubble_start", "end")
        self.chat_box.mark_gravity("ai_bubble_start", "left")
        self.chat_box.insert("end", "  ...\n", "ai_text")
        self.chat_box.see("end")
        self.chat_box.config(state="disabled")
    ...
    def _close_ai_bubble(self):
        self.chat_box.config(state="normal")
        self.chat_box.delete("ai_bubble_start", "end")
    ...
    def _resize_entry(self, event=None):
        ...
        self.entry.config(height=max(1, min(lines, 5)))
